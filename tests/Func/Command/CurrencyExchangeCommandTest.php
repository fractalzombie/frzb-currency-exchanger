...
use App\Domain\Bin\Model\BankInfo;
use App\Domain\Bin\Model\BinInfo;
use App\Domain\Bin\Model\CountryInfo;
use App\Domain\Bin\Model\NumberInfo;
...
class CurrencyExchangeCommandTest extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        self::getContainer()->set(CurrencyRateProviderInterface::class, $this->getCurrencyRateProvider());
        self::getContainer()->set(BinProviderInterface::class, $this->getBinProvider());
    ...
    private static function getBinProvider(): BinProviderInterface
    {
        return new class() implements BinProviderInterface {
            #[\Override]
            public function getInfo(BinInterface $bin): BinInfo
            {
                return match ((string) $bin) {
                    '516793' => new BinInfo(
                        'mastercard',
                        BinType::Debit,
                    ...
                    '4745030' => new BinInfo(
                        ...
                        new BankInfo('Uab Finansines Paslaugos Contis'),
                        numberInfo: new NumberInfo(),
                    ),
                    '45417360' => new BinInfo(
                        'visa',
                        BinType::Credit,
                        'Visa Classic',
                        new CountryInfo(
                        ...
                        new BankInfo('Credit Saison Co., Ltd.'),
                        numberInfo: new NumberInfo(),
                    ),
                    '45717360' => new BinInfo(
                        'visa',
                        BinType::Debit,
                        'Visa Classic',
                        new CountryInfo(
                        ...
                        new BankInfo('Jyske Bank A/S'),
                        numberInfo: new NumberInfo(),
                    ),
                    default => BinInfo::fromEmpty(),
                };
            }
        };
    }

    private static function getCurrencyRateProvider(): CurrencyRateProviderInterface
    {
        return new class() implements CurrencyRateProviderInterface {
            #[\Override]
            public function getRates(Currency $baseCurrency, ExchangeAmount ...$currencies): ExternalCurrencyRateProviderResponse
            {
                return new ExternalCurrencyRateProviderResponse(
