...
class NotEuroExchanger implements ExchangerInterface
{
    #[\Override]
    public function exchange(ExchangeContext $context): ExchangedAmount|ExchangedError
    {
        return new ExchangedAmount(
            $context->exchangeAmount->amount / $context->rate * CommissionHelper::getCommissionByContext($context),
    ...
    {
        return Currency::Euro !== $context->exchangeAmount->currency || $context->rate > 0;
    }
}
